...
<form method="get" action="{{ route('leech_movie') }}">
    {!! Form::select('page', range(0, 2000), isset($selectedPage) ? $selectedPage : 1, [
                        ...
                        @foreach ($resp['items'] as $key => $res)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('leech-detaiil', $res['slug']) }}" class="btn btn-primary">Chi tiết
                                        phim</a>
                                    <a href="{{ route('leech_episode', $res['slug']) }}" class="btn btn-secondary">Xem số tập
                                        phim</a>
                                    @php
